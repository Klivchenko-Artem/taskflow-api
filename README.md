...
OpenAPI, 38 тестов, запуск одной командой в Docker.
...
| Тесты | PHPUnit 12, 38 функциональных тестов |
...
- **Task** — задача внутри проекта: статус, приоритет, срок, исполнитель;
...
38 функциональных тестов на SQLite в памяти. Покрыто: регистрация и вход,
